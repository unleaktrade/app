...
import { SettleQuote } from "@/app/components/SettleQuote";

/** Loads the quote + parent RFQ + config, then renders the settlement cockpit. */
export function SettleQuoteWrapper() {
  ...
  return (
    <SettleQuote
      ...
      rfqPda={rfqPda}
      rfq={rfqQuery.data}
      facilitatorFeeBps={configQuery.data?.facilitatorFeeBps ?? 0}
