...
export function CreateRFQModal({ open, onOpenChange }: CreateRFQModalProps) {
  ...
  const [selectionTtlSecs, setSelectionTtlSecs] = useState("1800");
      ...
      <DialogContent className="bg-[#0f0f1a] border-white/10 text-white max-w-3xl max-h-[90vh] overflow-hidden flex flex-col">
        <DialogHeader>
          ...
          <DialogDescription className="sr-only">
            Multi-step form to create a new RFQ with token selection, economics configuration,
            timing settings, and final review
          </DialogDescription>
